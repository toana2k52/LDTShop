						...
						<div class="card-body">
							...
							<div class="col-md-6 col-edit">
								...
								<div id="news_div_class" style="float: left; margin-bottom: 20px;">
									<div id="targetOuter">
										...
										<img style="width: 450px; height: 300px;" src="" class="icon-choose-image grid-view-img" >
									</div>
							...
							<div class="col-md-6 col-edit">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="cpu" required="required">
									@if($errors->has('cpu'))
									<div class="text-danger">
										{{$errors->first('cpu')}}
									</div>
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" name="hard_drive" required="required">
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" name="screen" required="required">
							...
							<div class="col-md-6 col-edit">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="connector" required="required">
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" name="operating_system" required="required">
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" name="design" required="required">
		...
		<script type="text/javascript">
			function showPreview(objFileInput) {
				if (objFileInput.files[0]) {
		            ...
		            $("#targetLayer").html('<img src="'+e.target.result+'" alt="Listing" class="img-fluid grid-view-img" style="width: 450px; height: 300px; position: absolute;">');
