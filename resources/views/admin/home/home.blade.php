...
<body>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="p-t-30">
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{route('admin.index')}}" aria-expanded="false"><i class="fa fa-home"></i><span class="hide-menu the-a-menu">Trang chủ</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{route('admin.brand')}}" aria-expanded="false"><i class="fa fa-podcast" aria-hidden="true"></i><span class="hide-menu the-a-menu">Thương hiệu</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{route('admin.category')}}" aria-expanded="false"><i class="fa fa-qrcode" aria-hidden="true"></i><span class="hide-menu the-a-menu">Danh mục</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{route('admin.product')}}" aria-expanded="false"><i class="fa fa-cubes" aria-hidden="true"></i><span class="hide-menu the-a-menu">Sản phẩm</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{route('admin.order')}}" aria-expanded="false"><i class="fa fa-clipboard" aria-hidden="true"></i><span class="hide-menu the-a-menu">Đơn hàng</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{route('admin.info')}}" aria-expanded="false"><i class="fa fa-user-circle" aria-hidden="true"></i><span class="hide-menu the-a-menu">Tài khoản</span></a></li>
                        @if((Auth::user()->position) == 1)
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{route('admin.member')}}" aria-expanded="false"><i class="fa fa-cogs" aria-hidden="true"></i><span class="hide-menu the-a-menu">Quản lý nhân viên</span></a></li>
                        @endif()
                    </ul>
                </nav>
    ...
    <div class="page-wrapper">
        ...
        <footer class="footer text-center">
            XXX.com - Trang quản trị admin - Bản Quyền thuộc về <a href="{{route('user.index')}}">XXX.com</a>
        </footer>
        <!-- ============================================================== -->
        <!-- End footer -->
        <!-- ============================================================== -->
